...
class SamplePool:
    ...
    def commit(self, yp):
        ...
        if random.random() < 0.5:
            self.pool[self.indicies[0]] = Tensor.zeros_like(self.pool[self.indicies[0]])
        self.indicies = None
